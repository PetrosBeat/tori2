...
//establecemos la carpeta en la que queremos guardar los pdfs,
        ...
        $this->html2pdf->filename("HE".$rut.'.pdf');
   ...
   $titulo ="Horas Extras ";
        ...
        //si el pdf se guarda correctamente lo mostramos en pantalla
         ...
         $this->html2pdf->html(utf8_decode($this->load->view('Pdf/HorasExtras', $data, true,'UTF-8')));
    ...
    public function show($rut)
    {
        ...
        {
            $filename = "HE".$rut.".pdf";
            $route = base_url("files/pdfs/HE".$rut.".pdf");
            if(file_exists("./files/pdfs/HE".$filename))
            {
