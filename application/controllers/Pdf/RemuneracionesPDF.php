...
class RemuneracionesPDF extends CI_Controller {
...
//establecemos la carpeta en la que queremos guardar los pdfs,
   ...
   $titulo ="CONTRATO DE TRABAJO ";
        ...
        //si el pdf se guarda correctamente lo mostramos en pantalla
         ...
         $this->html2pdf->html(utf8_decode($this->load->view('Pdf/RemuneracionesPDF', $data, true,'UTF-8')));
    ...
    public function show($rut)
    {
        ...
        {
            $filename = $rut.".pdf";
            $route = base_url("files/pdfs/".$rut.".pdf");
