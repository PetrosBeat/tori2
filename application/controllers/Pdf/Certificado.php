...
//establecemos la carpeta en la que queremos guardar los pdfs,
        ...
        $this->html2pdf->filename("C".$rut.'.pdf');
   ...
   $titulo ="CERTFICADO DE TRABAJO ";
        ...
        //si el pdf se guarda correctamente lo mostramos en pantalla
         ...
         $this->html2pdf->html(utf8_decode($this->load->view('Pdf/Certificado', $data, true,'UTF-8')));
    ...
    public function show($rut)
    {
        ...
        {
            $filename = $rut.".pdf";
            $route = base_url("files/pdfs/C".$rut.".pdf");
            if(file_exists("./files/pdfs/C".$filename))
            {
