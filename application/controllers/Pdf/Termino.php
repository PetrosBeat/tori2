...
//establecemos la carpeta en la que queremos guardar los pdfs,
        ...
        $this->html2pdf->filename('T'.$rut.'.pdf');
   ...
   $titulo ="TERMINO CONTRATO DE TRABAJO ";
        ...
        //si el pdf se guarda correctamente lo mostramos en pantalla
         ...
         $this->html2pdf->html(utf8_decode($this->load->view('Pdf/Termino', $data, true,'UTF-8')));
    ...
    public function show($rut)
    {
        ...
        {
            $filename = "T".$rut.".pdf";
            $route = base_url("files/pdfs/T".$rut.".pdf");
