...
//establecemos la carpeta en la que queremos guardar los pdfs,
        ...
        $this->html2pdf->filename("Indumentaria-".$rut.'.pdf');
   ...
   $titulo ="CONTRATO DE TRABAJO ";
        ...
        //si el pdf se guarda correctamente lo mostramos en pantalla
         ...
         $this->html2pdf->html(utf8_decode($this->load->view('Pdf/Indumentaria', $data, true,'UTF-8')));
    ...
    public function show($rut)
    {
        ...
        {
            $filename = "Indumentaria-".$rut.".pdf";
            $route = base_url("files/pdfs/Indumentaria-".$rut.".pdf");
